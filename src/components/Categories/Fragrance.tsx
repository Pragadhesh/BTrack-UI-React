...
function Fragrance() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      setIsLoading(true);
      try {
        const response = await axios.get(`${BACKEND_URL}product/fragrance`, {
          headers: {
            ...
            <Box sx={categorystyle}>
              <div className="flex flex-col w-full">
                <div className="grid grid-flow-row gap-3 w-full h-full">
                  ...
                  <div className="grid grid-flow-cols gap-3 h-full pt-5">
                    <button
                      className="flex justify-center pl-5 category"
                      onClick={() => openAddItem("luxury")}
                    >
                      Luxury
                    </button>
                    <button
                      className="flex justify-center pl-5 category"
                      onClick={() => openAddItem("beautiful")}
                    >
                      Beautiful
                    </button>
                    <button
                      className="flex justify-center pl-5 category"
                      onClick={() => openAddItem("modernmuse")}
                    >
                      Modern Muse
                    </button>
                    <button
                      className="flex justify-center pl-5 category"
                      onClick={() => openAddItem("pleasures")}
                    >
                      Pleasures
                    </button>
                  </div>
