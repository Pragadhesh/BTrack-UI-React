              ...
              <div className="flex flex-col w-full">
                <div className="grid grid-flow-row gap-3 w-full">
                  ...
                  <div className="grid grid-cols-3 w-full h-full p-5">
                    <div className="grid grid-rows-6 row-start-1 row-end-7 gap-3 ">
                      <div className="flex font-playfair font-bold text-lg h-6">
                        Face
                      </div>
                      <button
                        className="flex category h-6"
                        onClick={() => openAddItem("foundation")}
                      >
                        Foundation
                      </button>
                      <button
                        className="flex category h-6"
                        onClick={() => openAddItem("powder")}
                      >
                        Powder & Compacts
                      </button>
                      <button
                        className="flex category h-6"
                        onClick={() => openAddItem("concealer")}
                      >
                        Concealer
                      </button>
                      <button
                        className="flex category h-6"
                        onClick={() => openAddItem("primer")}
                      >
                        Primer
                      </button>
                      <button
                        className="flex category h-6"
                        onClick={() => openAddItem("highlighter")}
                      >
                        Highlighter
                      </button>
                    </div>
                    <div className="grid grid-rows-5 row-start-1 row-end-6 gap-3">
                      <div className="flex font-playfair font-bold text-lg h-6">
                        Eye
                      </div>
                      <button
                        className="flex category h-6"
                        onClick={() => openAddItem("eyeliner")}
                      >
                        Eyeliner
                      </button>
                      <button
                        className="flex category h-6"
                        onClick={() => openAddItem("mascara")}
                      >
                        Mascara
                      </button>
                      <button
                        className="flex category h-6"
                        onClick={() => openAddItem("eyeshadow")}
                      >
                        Eyeshadow
                      </button>
                      <button
                        className="flex category h-6"
                        onClick={() => openAddItem("brows")}
                      >
                        Brows
                      </button>
                    </div>
                    <div className="grid grid-rows-5 row-start-1 row-end-6 gap-3">
                      ...
                      <button
                        className="flex category h-6"
                        onClick={() => openAddItem("lipstick")}
                      >
                        Lipsticks
                      </button>
                      <button
                        className="flex category h-6"
                        onClick={() => openAddItem("liquidlipstick")}
                      >
                        Liquid Lipstick
                      </button>
                      <button
